...
################################################################################
## Form generated from reading UI file '_UI_Options.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.b_RightM, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.b_LeftM, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.w_RightM, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.w_LeftM, 3, 1, 1, 1)
        ...
        self.b_FromPt = QPushButton(self.gridLayoutWidget)
        self.b_FromPt.setObjectName(u"b_FromPt")
        self.b_FromPt.setMinimumSize(QSize(150, 40))
        self.b_FromPt.setMaximumSize(QSize(150, 40))

        self.gridLayout.addWidget(self.b_FromPt, 2, 0, 1, 1)

        self.w_FromPt = QWidget(self.gridLayoutWidget)
        self.w_FromPt.setObjectName(u"w_FromPt")
        self.w_FromPt.setMinimumSize(QSize(120, 30))
        self.w_FromPt.setMaximumSize(QSize(120, 30))

        self.gridLayout.addWidget(self.w_FromPt, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.b_FromPt.setText(QCoreApplication.translate("Dialog", u"From PT", None))
    # retranslateUi
