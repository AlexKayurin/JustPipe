...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.b_CurrentProf, 8, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.w_CurrentProf, 8, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.b_Vis, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.b_MADJ, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.w_MSBL, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.w_Background, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.b_Background, 9, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.w_Vis, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.b_Pipetracker, 7, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.w_Pipetracker, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.w_MADJ, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.b_MSBL, 6, 0, 1, 1)
