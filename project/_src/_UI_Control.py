...
class Ui_CONTROL(object):
    def setupUi(self, CONTROL):
        ...
        self.toolBoxPtSet.setMinimumSize(QSize(155, 125))
        self.toolBoxPtSet.setMaximumSize(QSize(155, 125))
        self.toolBoxPtSet.setFrameShape(QFrame.Shape.Box)
        self.pts0 = QWidget()
        self.pts0.setObjectName(u"pts0")
        self.pts0.setGeometry(QRect(0, 0, 153, 30))
        ...
        self.pts1.setGeometry(QRect(0, 0, 153, 30))
        ...
        self.t_EdSpot = QLineEdit(self.pts2)
        self.t_EdSpot.setObjectName(u"t_EdSpot")
        self.t_EdSpot.setEnabled(False)
        self.t_EdSpot.setGeometry(QRect(0, 0, 80, 30))
        ...
        self.toolBoxPtSet.addItem(self.pts2, u"Reject window")

        self.verticalLayout_3.addWidget(self.toolBoxPtSet)

        self.toolBoxPtEdit = QToolBox(self.tabPT)
        self.toolBoxPtEdit.setObjectName(u"toolBoxPtEdit")
        self.toolBoxPtEdit.setMinimumSize(QSize(155, 200))
        self.toolBoxPtEdit.setMaximumSize(QSize(155, 200))
        self.toolBoxPtEdit.setFrameShape(QFrame.Shape.Box)
        self.pte0 = QWidget()
        self.pte0.setObjectName(u"pte0")
        self.pte0.setGeometry(QRect(0, 0, 153, 108))
        self.label = QLabel(self.pte0)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(10, 0, 20, 30))
        self.label.setMinimumSize(QSize(20, 30))
        self.label.setMaximumSize(QSize(20, 30))
        self.label_2 = QLabel(self.pte0)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(10, 30, 20, 30))
        self.label_2.setMinimumSize(QSize(20, 30))
        self.label_2.setMaximumSize(QSize(20, 30))
        self.sp_smW_A = QDoubleSpinBox(self.pte0)
        self.sp_smW_A.setObjectName(u"sp_smW_A")
        self.sp_smW_A.setEnabled(False)
        self.sp_smW_A.setGeometry(QRect(30, 0, 120, 30))
        self.sp_smW_A.setMinimumSize(QSize(120, 30))
        self.sp_smW_A.setMaximumSize(QSize(120, 30))
        self.sp_smW_A.setFont(font2)
        self.sp_smW_A.setDecimals(2)
        self.sp_smW_A.setMinimum(0.010000000000000)
        self.sp_smW_A.setMaximum(1.000000000000000)
        self.sp_smW_A.setSingleStep(0.050000000000000)
        self.sp_smW_B = QDoubleSpinBox(self.pte0)
        self.sp_smW_B.setObjectName(u"sp_smW_B")
        self.sp_smW_B.setEnabled(False)
        self.sp_smW_B.setGeometry(QRect(30, 30, 120, 30))
        self.sp_smW_B.setMinimumSize(QSize(120, 30))
        self.sp_smW_B.setMaximumSize(QSize(120, 30))
        self.sp_smW_B.setFont(font2)
        self.sp_smW_B.setDecimals(5)
        self.sp_smW_B.setMinimum(0.000010000000000)
        self.sp_smW_B.setMaximum(0.995000000000000)
        self.sp_smW_B.setSingleStep(0.000500000000000)
        self.b_smoothPT_l_AB = QPushButton(self.pte0)
        self.b_smoothPT_l_AB.setObjectName(u"b_smoothPT_l_AB")
        self.b_smoothPT_l_AB.setEnabled(False)
        self.b_smoothPT_l_AB.setGeometry(QRect(75, 65, 75, 40))
        self.b_smoothPT_l_AB.setMinimumSize(QSize(75, 40))
        self.b_smoothPT_l_AB.setMaximumSize(QSize(75, 40))
        self.b_smoothPT_l_AB.setFont(font2)
        self.b_smoothPT_p_AB = QPushButton(self.pte0)
        self.b_smoothPT_p_AB.setObjectName(u"b_smoothPT_p_AB")
        self.b_smoothPT_p_AB.setEnabled(False)
        self.b_smoothPT_p_AB.setGeometry(QRect(0, 65, 75, 40))
        sizePolicy1 = QSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.b_smoothPT_p_AB.sizePolicy().hasHeightForWidth())
        self.b_smoothPT_p_AB.setSizePolicy(sizePolicy1)
        self.b_smoothPT_p_AB.setMinimumSize(QSize(75, 40))
        self.b_smoothPT_p_AB.setMaximumSize(QSize(75, 40))
        self.b_smoothPT_p_AB.setFont(font2)
        self.b_smoothPT_p_AB.setFlat(False)
        self.toolBoxPtEdit.addItem(self.pte0, u"Smooth A-B")
        self.pte1 = QWidget()
        self.pte1.setObjectName(u"pte1")
        self.pte1.setGeometry(QRect(0, 0, 153, 108))
        self.t_smW = QLineEdit(self.pte1)
        ...
        self.b_smoothPT_p_MA = QPushButton(self.pte1)
        ...
        self.b_smoothPT_p_MA.setFont(font2)
        self.b_smoothPT_p_MA.setFlat(False)
        self.b_smoothPT_l_MA = QPushButton(self.pte1)
        ...
        self.b_smoothPT_l_MA.setFont(font2)
        self.l2 = QLabel(self.pte1)
        ...
        self.toolBoxPtEdit.addItem(self.pte1, u"Smooth MA")
        self.pte2 = QWidget()
        self.pte2.setObjectName(u"pte2")
        self.t_Lev = QLineEdit(self.pte2)
        ...
        self.verticalLayout_3.addWidget(self.b_savePT)
        ...
        self.verticalLayout_3.addWidget(self.b_analysePtShift)
        ...
        self.toolBoxPtSet.setCurrentIndex(2)
        self.toolBoxPtEdit.setCurrentIndex(0)
        self.toolBoxPtEdit.layout().setSpacing(5)
    ...
    def retranslateUi(self, CONTROL):
        ...
        self.toolBoxPtSet.setItemText(self.toolBoxPtSet.indexOf(self.pts2), QCoreApplication.translate("CONTROL", u"Reject window", None))
        self.label.setText(QCoreApplication.translate("CONTROL", u"A", None))
        self.label_2.setText(QCoreApplication.translate("CONTROL", u"B", None))
        self.b_smoothPT_l_AB.setText(QCoreApplication.translate("CONTROL", u"SmZ", None))
        self.b_smoothPT_p_AB.setText(QCoreApplication.translate("CONTROL", u"Sm", None))
        self.toolBoxPtEdit.setItemText(self.toolBoxPtEdit.indexOf(self.pte0), QCoreApplication.translate("CONTROL", u"Smooth A-B", None))
        ...
        self.toolBoxPtEdit.setItemText(self.toolBoxPtEdit.indexOf(self.pte1), QCoreApplication.translate("CONTROL", u"Smooth MA", None))
        ...
        self.toolBoxPtEdit.setItemText(self.toolBoxPtEdit.indexOf(self.pte2), QCoreApplication.translate("CONTROL", u"Level", None))
        self.b_savePT.setText(QCoreApplication.translate("CONTROL", u"Save PT", None))
        self.b_analysePtShift.setText(QCoreApplication.translate("CONTROL", u"Analyse", None))
